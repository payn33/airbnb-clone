...
const Icon = styled.span`
  display: inline-flex;
  align-items: center;
  margin: ${({ margin }) => (margin === "left" ? "0 0 0 8px " : "0 8px 0 0")};
  cursor: pointer;
`;
...
const Footer = () => {
  ...
  return (
    <Div width={windowSize.width}>
      <Flex>
        <FlexLeft>
          <P weight={399}>© 2022 Airbnb, Inc.</P>
          <Dot />
          <P hover cursor weight={399}>
            Privacy
          </P>
          <Dot />
          <P hover cursor weight={399}>
        ...
        <FlexRight>
          ...
          <Icon margin={"left"}>
            ...
            >
              <path
                d="M2 13.9998L13.2929 2.70696C13.6834 2.31643 14.3166 2.31643 14.7071 2.70696L26 13.9998"
                stroke="black"
                strokeWidth="4"
              />
            </svg>
